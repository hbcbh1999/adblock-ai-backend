...
def __create_prediction_request__(image):
    ...
    request.model_spec.name = settings.AD_MODEL_NAME
    request.model_spec.signature_name = settings.AD_MODEL_SIGNATURE_NAME
    request.inputs[settings.AD_MODEL_INPUTS_KEY].CopyFrom(
